...
import 'package:loc_coupon/UI/signUp.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(hintText: 'email',hintStyle: GoogleFonts.poppins(fontSize: 24,color: Colors.blueGrey),),
                ...
                Container(
                  ...
                  child: TextFormField(
                    style: GoogleFonts.poppins(color: Colors.white),
                    decoration: InputDecoration(hintText: 'password',hintStyle: GoogleFonts.poppins(fontSize: 24,color: Colors.blueGrey),),
                    obscureText: true,
                ...
                Row(
                  ...
                  children: [
                    Text("googleLogin",style: GoogleFonts.poppins(fontSize: 20,color: Colors.white),),
                ...
                ElevatedButton(
                    ...
                    onPressed: (){
                      if(_formKey.currentState!.validate()) {
                        final result = _auth.signInWithEmailPassword(email, pass);
                        print(result);
                      }
                      else{}
                    },
                ...
                const SizedBox(height: 10),
                TextButton(onPressed: (){Get.to(const SignUp());}, child: Text("sign-up",style: GoogleFonts.poppins(fontSize: 20),)),
