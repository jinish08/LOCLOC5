...
const Hero = () => {
  ...
  return (
    <section class="h-screen">
      <div class="w-[1oovw]">
        <div class="g-6 flex h-screen flex-wrap items-center justify-center lg:justify-between">
          <div class="mb-12 md:mb-0 md:w-8/12 lg:w-6/12">
            <div class="relative">
              <img src={"login.png"} class="h-screen object-fill" />
              <img
                src={"laptop.png"}
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/3"
              />
