...
const steps = [
  {
    ...
    imgSrc: 'https://assets6.lottiefiles.com/packages/lf20_x17ybolp.json'
  },
  {
    key: 2,
  ...
  {
    key: 3,
    text:"Track and optimise coupons!",
    imgSrc: '/laptop.png'
  }
]
...
const Landing = () => {
  return (
    <>
      ...
      <main>
      <div>  
    <nav className="bg-primary border-gray-200 px-2 sm:px-4 text-white py-2.5 rounded dark:bg-gray-900">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <Link href="/" className="flex items-center">
            <img src="  /docs/images/logo.svg" className="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">VoucherVerse</span>
        </Link>
      ...
      <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold pt-0.5 px-2 rounded-full">
                Get started!
            </button>
        </li>
      </ul>
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-0 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-black ">Maximize Your Sales with Our Promotion Engine That Never Fails!</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl text-black">With our software, you can create personalized campaigns that target your customers' behavior and preferences, offering them incentives and rewards that they'll love.</p>
            <Link href="/register" class="inline-flex items-center justify-center px-5 mr-5 py-3 mr-3 text-base font-medium text-center rounded-lg bg-hero-700 hover:bg-hero-800 focus:ring-4 focus:ring-hero-300 text-white">
                Find your Partner
        ...
        <div className='flex'>
          <Image src={"/laptop.png"} alt='background'  width={1700}  height={100} className='absolute -z-10 object-contain' />
        <div className='flex items-center justify-center w-full h-full py-32 space-x-14 bg-gray-100'>
        {steps.map((step,index) => (
          <StepsCard id={index+1} text={step.text} imgSrc={step.imgSrc} key={index} />
        ))}
        </div>
        </div>
        <footer class="bg-primary dark:bg-gray-900 text-white">
